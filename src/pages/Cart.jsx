...
const Cart = () => {
    ...
    const[addresses,setShowAddresses]=useState(dummyAddress)
        ...
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                className="group cursor-pointer flex items-center mt-8 gap-2 text-primary font-medium">
                    <img  className="group-hover:-translate-x-1"src=
                    {assets.arrow_right_icon_colored} alt="arrow" />
                    Continue Shopping
                </button>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                         ...
                         {address.street}, {address.city}, {address.state}, {address.country}
                                ...
                                <p onClick={() => navigate("/add-address")} className="text-pwhite text-center cursor-pointer p-2 primary">
                                    Add address
                                </p>
                            </div>
                        )}
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer primary text-pwhite font-medium  transition">
